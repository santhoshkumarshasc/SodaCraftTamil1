...
import { Copy, Check, ExternalLink, ShieldCheck, Smartphone, IndianRupee } from "lucide-react";
...
export function UpiQrCode({
  ...
  // Build standard NPCI UPI payment URL
  const upiUrl = (() => {
  ...
  return (
    ...
    >
      <h3 className="text-xl sm:text-2xl font-black tracking-tight mb-1">Scan & Pay via UPI</h3>
      <p
      ...
      <div className="relative group">
        ...
        {amount && amount > 0 && (
          <div className="mt-3 flex items-center justify-center">
            <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[oklch(0.65_0.24_25)]/20 text-[oklch(0.75_0.22_25)] text-xs font-bold border border-[oklch(0.65_0.24_25)]/30">
              <span>Amount:</span>
      ...
      {/* Instruction banner */}
      <div
        className={`mt-5 w-full max-w-sm rounded-xl p-3 text-xs text-left border ${
      ...
      >
        <div className="flex items-start gap-2">
          ...
          <span className="opacity-90">
            Open <strong>Google Pay / PhonePe / Paytm</strong>, scan this QR code, and complete your
            payment. Fill in your name to generate your official payment receipt!
          </span>
        </div>
      </div>
      ...
      {/* One-click Mobile UPI App Launchers */}
      <div className="mt-6 w-full max-w-sm">
        <div className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-3 flex items-center justify-center gap-1.5">
          ...
          <span>Pay Directly via App</span>
        </div>
